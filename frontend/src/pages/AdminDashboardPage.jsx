...
export default function AdminDashboardPage() {
  ...
  return (
    <div className={isMobileSidebarOpen ? "dashboard-page sidebar-open" : "dashboard-page"} data-testid="admin-dashboard-page">
      {isMobileSidebarOpen && (
        <button
          type="button"
      ...
      <aside className="sidebar" data-testid="admin-sidebar">
        <div className="sidebar-mobile-top" data-testid="admin-sidebar-mobile-top">
          <button
            type="button"
      ...
      <main className="dashboard-content" data-testid="admin-main-content">
        <div className="dashboard-topbar" data-testid="admin-topbar">
          ...
          <div className="topbar-controls" data-testid="admin-topbar-controls">
            <button
              className="primary-btn mobile-only-btn"
